...
namespace EasyHookLib
{
    public class CreateProcessWHooker : HookerBase
    {
            ...
            string lpCurrentDirectory, ref StartupInfoW lpStartupInfo, ref ProcessInformation pInfo)
        {
            ...
            var processHook = Win32Interop.CreateProcessW(lpApplicationName, lpCommandLine,
        ...
        {
            IntPtr inTargetProc = LocalHook.GetProcAddress("kernel32.dll", "CreateProcessW");
            Delegate delegateToCall = new CreateProcessDelegateW(CreateProcessHook);
